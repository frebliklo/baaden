...
export const getImgSrcSet = image => {
  ...
  return `${imageBaseUrl}${baseWidth}x${baseHeight}/center/, ${imageBaseUrl}${baseWidth*1.5}x${baseHeight*1.5}/center/ 1.5x, ${imageBaseUrl}${baseWidth*2}x${baseHeight*2}/center/ 2x, ${imageBaseUrl}${baseWidth*3}x${baseHeight*3}/center/ 3x`
}
